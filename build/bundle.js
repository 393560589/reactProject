...
/***/ function(module, exports, __webpack_require__) {
	...
	var newFastClick = __webpack_require__(206);
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'wechatImg' },
	                    React.createElement('img', { src: '', alt: 'xx的头像' })
	                ),
	                React.createElement(
	                    'h4',
	                    { className: 'myBalanceTit mix' },
	                    'xx的余额'
	                ),
	                React.createElement(
	                    'p',
	                    { className: 'mix myBalanceNum' },
	                    React.createElement(
	                        'b',
	                        null,
	                        '1.00'
	                ...
	                React.createElement(
	                    'ul',
	                    { className: 'btnbox clearfix' },
	                    React.createElement(
	                        'li',
	                        { className: 'base-btn credit' },
	                        React.createElement(
	                            Link,
	                            { to: '/cash' },
	                    ...
	                    React.createElement(
	                        'li',
	                        { className: 'base-btn cash' },
	                        React.createElement(
	                            Link,
	                            { to: '/mo' },
	                            React.createElement('i', { className: 'icnonfont' }),
	                            '夺宝(敬请期待)'
	                        )
	                    )
	                )
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'li',
	                        { className: 'common clearfix' },
	                        React.createElement(
	                            'i',
	                            { className: 'iconfont pull-left' },
	                            ''
	                        ),
	                        React.createElement('input', { id: 'allCash', className: 'pull-left', type: 'tel', placeholder: '请输入提现金额' })
	                    ),
	                    React.createElement(
	                        'li',
	                        { className: 'nowCash common clearfix' },
	                        React.createElement(
	                            'span',
	                            { className: 'pull-left' },
	                            '当前余额：',
	                        ...
	                        React.createElement(
	                            'span',
	                            { className: 'pull-right allTake', onClick: this.takeClick },
	                            '全部提现'
	                        )
	                    )
	                )
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'p',
	                    null,
	                    '1.为了更好的保障您的资金安全，提现需要审核，审核在两个工作日内完成'
	                ),
	                React.createElement(
	                    'p',
	                    null,
	                    '2.请尽量完善您的微信资料，完成微信实名认证，以享受更高的微信提现额度'
	                ),
	                React.createElement(
	                    'p',
	                    null,
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'a',
	                    { id: 'prve', onClick: this.leftMove },
	                    '左边'
	                ),
	                React.createElement(
	                    'a',
	                    { id: 'next', onClick: this.rightMove },
	                    '右边'
	                )
	            )
	        );
