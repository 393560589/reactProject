...
/******/ 	var hotCurrentHash = "6275500e070f847832be"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	//module
	var Account = __webpack_require__(222);
	var Shark = __webpack_require__(226);
	var Play = __webpack_require__(227);

	var routes = React.createElement(Router, null, React.createElement(Route, { name: 'user', path: '/', component: Account }), React.createElement(Route, { name: 'cash', path: 'cash', component: Shark }), React.createElement(Route, { name: 'play', path: 'play', component: Play }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reqwest = __webpack_require__(224);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navbar = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement('div', { className: 'fixednav' }, React.createElement('ul', { className: 'clearfix' }, React.createElement('li', null, React.createElement(Link, { to: '/play' }, React.createElement('i', { className: 'iconfont' }, ''), '摇一摇')), React.createElement('li', null, React.createElement(Link, { to: '/cash' }, React.createElement('i', { className: 'iconfont' }, ''), '提现')), React.createElement('li', null, React.createElement(Link, { to: '/' }, React.createElement('i', { className: 'iconfont' }, ''), '账户'))));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Shark = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement('div', { className: 'takeMoney' }, React.createElement('div', { className: 'titwrap' }, React.createElement('ul', null, React.createElement('h4', { className: 'common' }, '提现金额'), React.createElement('li', { className: 'common clearfix' }, React.createElement('i', { className: 'iconfont pull-left' }, ''), React.createElement('input', { className: 'pull-left', type: 'tel', placeholder: '请输入提现金额' })), React.createElement('li', { className: 'nowCash common clearfix' }, React.createElement('span', { className: 'pull-left' }, '当前余额：', React.createElement('b', null, '1.00元')), React.createElement('span', { className: 'pull-right allTake' }, '全部提现')))), React.createElement('a', { className: 'base-btn' }, '提现'), React.createElement('p', { className: 'p-detail' }, '本月还可以提现', React.createElement('b', null, '3'), '次'), React.createElement('ul', { className: 'rules' }, React.createElement('h4', null, '提现规则'), React.createElement('p', null, '1.为了更好的保障您的资金安全，提现需要审核，审核在两个工作日内完成'), React.createElement('p', null, '2.请尽量完善您的微信资料，完成微信实名认证，以享受更高的微信提现额度'), React.createElement('p', null, '3.每月可提现3次，满一元可申请提现'), React.createElement('p', null, '4.审核结果请留意公众号消息')), React.createElement(Navbar, null));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Play = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement('div', { className: 'playHappy', ref: 'playHappy', id: 'playHappy' }, React.createElement('div', { className: 'backGame' }, React.createElement('div', { id: 'game' })), React.createElement(Navbar, null));
	    }
	});

	module.exports = Play;

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(219); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "play.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
